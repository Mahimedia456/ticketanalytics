...
export default function GoodSatisfactionDashboard({
  ...
  function exportPDF() {
    exportDashboardPDF("good-satisfaction-export", title);
  }
        ...
        <div className="pdf-section">
          ...
          >
            ...
            <p className="mt-2 text-white/90 font-medium">
              Good satisfaction tickets with comments and reason notes analysis.
            </p>
          </div>
        </div>
...
function TicketTable({ title, rows = [] }) {
  return (
    <div className="dashboard-card p-5 pdf-section">
      <h3 className="font-black text-lg mb-4">{title}</h3>

      <div className="overflow-auto max-h-[720px] rounded-xl border border-slate-100 pdf-expand">
